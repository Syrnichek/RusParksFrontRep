...
export default {
  ...
  methods: {
    ...
    async fetchPosts(){
      try{
        ...
        const response = await axios.get('http://localhost:5069/api/parkManage/GetParksAll').then(response=>console.log(response));
  ...
  mounted() {
    axios.get('https://localhost:7110/api/parkManage/GetParksAll').then(response=>console.log(response));
  }
}
</script>
